...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('/kaggle/input/cctv-train/', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    ...
    val_set = ValDatasetFromFolder('/kaggle/input/cctv-validation/', upscale_factor=UPSCALE_FACTOR)
