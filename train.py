...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('/kaggle/input/grasdad', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    ...
    val_set = ValDatasetFromFolder('/kaggle/input/face-grayscale-validation', upscale_factor=UPSCALE_FACTOR)
